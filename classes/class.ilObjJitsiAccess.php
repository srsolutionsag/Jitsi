 ...
 */
class ilObjJitsiAccess extends ilObjectPluginAccess
{
    ...
    {
        ilUtil::sendFailure(self::plugin()->translate("permission_denied", ilObjJitsiGUI::LANG_MODULE_OBJECT), true);
    ...
    {
        $object_settings = self::jitsi()->objectSettings()->getObjectSettingsById(intval($a_obj_id));
